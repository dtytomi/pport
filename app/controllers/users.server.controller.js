...
exports.edit = function(req, res) {
		...
		var user = req.user;
		var specialties = req.body.specialty;
		...
		if (user) {
			//Merge Eexisting user
			user = _.extend(user, req.body);
			user.updated = Date.now();
			user.displayName = user.firstName + ' ' + user.lastName;

			user.areaOfSpecialization.unshift(specialties);
...
exports.changePassword = function(req, res, next) {
	...
	if (req.user) {  	// For security measurement we remove the roles from the req.body object
	delete req.body.roles;
